"""
::BOH
$Id: __init__.py,v 1.3 2006/12/07 05:25:13 peterk Exp $
...
from libs.ownet.connection import Connection


__author__ = 'Peter Kropf'
__email__ = 'pkropf@gmail.com'
__version__ = '0.2' + '-' + '$Id: __init__.py,v 1.3 2006/12/07 05:25:13 peterk Exp $'.split()[2]
