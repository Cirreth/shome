...
class ActionProcessor:
    ...
    def init(self, context):
        ...
        ActionProcessor.Scenario._action_processor = self
        ActionProcessor.Scenario._config = context.config
        self._config.mapper(ActionProcessor.Scenario)
        self._configuration = context.config

    def list_all(self):
        return self._configuration.get_all_processes()
    ...
    def update_process(self, tag, expression, description, published, runoninit):
    ...
    def build_process_tree(self, tag, expression):
        ...
        if isinstance(root_struct, list):
            ...
            raise Exception('Node type is not defined')
